...
const ListBox = ({
  ...
  // const darkModeStyle = darkMode ? styles.darkMode : "";
  ...
  if (ratings) {
    return (
      <div className={styles.container}>
        ...
        <label
          className={`${title ? styles.lbl : styles.lblWithoutTitle} ${darkMode ? styles.brightLabel : ''}`}
          onClick={toggling}
        >
          {value === "all" ? (
            "All"
        ...
        {isOpen && (
          <div className={styles.listWrapper}>
            <ul className={styles.list}>
              <li onClick={onOptionClicked("all")} className={styles.item}>
                All
              </li>
            ...
            <div className={styles.clickOutside} onClick={onClickOutside}></div>
          </div>
        )}
      </div>
    );
    ...
    return (
      <div className={styles.container}>
        ...
        >
          {value === "all"
            ? "All"
            : listItems?.filter((item: any) => item.value === value)[0].name}
        </label>
