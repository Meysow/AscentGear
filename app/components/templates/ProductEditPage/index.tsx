    ...
    if (!userInfo) {
      ...
      const fetchData = async () => {
        try {
          ...
          data.featuredImage && setSecuredURLFeatured(data.featuredImage);
      ...
      <div className={styles.container}>
        ...
        <div className={styles.containerRight}>
          ...
          <form onSubmit={handleSubmit(submitHandler)} className={styles.form}>
            <div>
              <label
                className={`${styles.lbl} ${darkMode ? styles.darkMode : ""}`}
              >
                Name
                <input
                  type="text"
            ...
            <div>
              ...
              {securedURL && (
                <>
                  <p className={styles.imageTitle}>Preview :</p>
              ...
              <div>
                ...
                >
                  ...
                  <input
                    ...
                    name="featuredFile"
                    className={styles.ipt}
                    onChange={(e) => uploadHandler(e, "featuredFile")}
                  />
                </label>
                {securedURLFeatured && (
                  <>
            ...
            <div className={styles.btnContainer}>
              <Button
                onClickHandler={() => console.log("Submit in Edit Page !")}
                submit
              >
                Update
              </Button>
